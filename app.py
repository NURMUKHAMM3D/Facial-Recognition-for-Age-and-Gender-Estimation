...
# Загрузка моделей
genmodel = load_model('C:/Users/zhara/Downloads/AML_final/gender_model.keras')  # Модель для пола
agemodel = load_model('C:/Users/zhara/Downloads/AML_final/age_model.keras')    # Модель для возраста
